<x-app-layout>
    ...
    <div class="md:max-w-6xl mx-auto ">
        <h1 class="md:text-5xl text-4xl mt-7 font-bold w-fit ">Test jouw kennis over bloeddruk</h1>
            ...
            <div class="p-8 mr-12 w-full md:w-2/3">
                <div class="bg-white rounded-md shadow-lg">
                    <form action="" method="post" class="p-4 grid grid-cols-1 gap-3">
                        @csrf
                        <div>
                            <label for="question-one" class="text-gray-900 text-sm font-semibold">Hoge bloeddruk vergroot de kans op een hartaanval</label>
                        ...
                        <div>
                            <label for="question-two" class="text-gray-900 text-sm font-semibold">Lage bloeddruk is is erg gevaarlijk</label>
                            <div class="w-2/3 mt-2 relative">
                                <div class="flex items-center">
                        ...
                        <div>
                            <label for="question-three" class="text-gray-900 text-sm font-semibold">Zoute dingen eten verhoogt je bloeddruk</label>
                            <div class="w-2/3 mt-2 relative">
                                <div class="flex items-center">
